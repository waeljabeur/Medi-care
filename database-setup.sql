-- Supabase Database Setup for Doctor Dashboard
...
-- Note: This will only work after you create a doctor account through the signup process

-- Function to automatically create doctor profile after signup
