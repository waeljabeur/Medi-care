-- Complete Database Setup for Doctor Dashboard
...
-- CRITICAL: Function to automatically create doctor profile when user signs up
...
EXCEPTION
  WHEN unique_violation THEN
    -- Doctor already exists, just return
    RETURN NEW;
  WHEN OTHERS THEN
